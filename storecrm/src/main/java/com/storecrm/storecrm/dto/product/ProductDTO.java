...
public class ProductDTO {
    ...
    @Schema(description = "The unique identifier for the product", example = "1", accessMode = Schema.AccessMode.READ_ONLY)
    private Long id;

    @NotBlank(message = "Art cannot be blank")
    @Size(max = 50, message = "Art cannot exceed 50 characters")
    @Schema(description = "The unique art code of the product", example = "ART12345")
    private String art;
    ...
    @Schema(description = "The description of the product", example = "A high-performance laptop with 16GB RAM.")
    ...
    @Schema(description = "The quantity of the product in stock", example = "50")
    private Integer stock;

    @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss")
    @Schema(description = "The date and time when the product was last updated", example = "2024-11-30T12:34:56")
    ...
    @NoArgsConstructor
    @Builder
    @Schema(description = "Response model for a product")
    ...
    @NoArgsConstructor
    @Builder
    @Schema(description = "Model for creating a new product")
